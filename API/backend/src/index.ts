...
app.put("/editar-info", (req, res) => {
    ...
    let SQL = ("UPDATE Usuarios SET usuario_nome = '"+nome+"', nome_usuario = '"+username+"' WHERE usuario_ID = '8f763eb2-1d71-4b5a-a715-b9505495c5de'")
...
app.get("/read", (_, res) => {
    ...
    let SQL = "SELECT usuario_nome, usuario_email, nome_usuario, usuario_tipo, to_char(usuario_data_criacao, 'DD/MM/YYYY') FROM usuarios WHERE usuario_ID = '8f763eb2-1d71-4b5a-a715-b9505495c5de'";
...
app.get("/readAcoes", (_, res) => {
    ...
    let SQL = "SELECT tipo_acao, to_char(data_acao, 'DD/MM/YYYY HH24:MI:SS')FROM acoes WHERE id_usuario = '8f763eb2-1d71-4b5a-a715-b9505495c5de'"
